...
public class SidePanelImpl extends JPanel implements ISidePanelImp
{
	/**
	 * 
	 */
...
private static final int TILE_SIZE = IBoardInterface.TILE_SIZE >> 1;
	
	/**
	 * The width of the shading on each tile on the next piece preview.
	 */
	private static final int SHADE_WIDTH = IBoardInterface.SHADE_WIDTH >> 1;
    ...
    public SidePanelImpl (TetrisImpl tetrisImp){
          
    	this.tetris = tetrisImp;
		setPreferredSize(new Dimension(200, IBoardInterface.PANEL_HEIGHT));
	...
	*/	
	...
	public void begin(){
//		setPreferredSize(new Dimension(200, IBoardType.PANEL_HEIGHT));
//		setBackground(Color.BLACK);
