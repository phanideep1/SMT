...
public class BoardPanel2 extends JPanel {
		 ...
		 */
		public static int ROW_COUNT = VISIBLE_ROW_COUNT + HIDDEN_ROW_COUNT;
		...
		public BoardPanel2(Tetris tetris) {
			this.tetris = tetris;
			this.tiles = new TileType2[ROW_COUNT][COL_COUNT];
		 ...
		 */
		public boolean isValidAndEmpty(TileType2 type, int x, int y, int rotation) {
		 ...
		 * @param rotation The rotation of the piece.
		 */
		public void addPiece(TileType2 type, int x, int y, int rotation) {
			/*
		 ...
		 */
		private void setTile(int  x, int y, TileType2 type) {
			tiles[y][x] = type;
		}
		 ...
		 * @return The tile.
		 */
		private TileType2 getTile(int x, int y) {
			return tiles[y][x];
		}
		...
		public void paintComponent(Graphics g) {
			...
			if(tetris.isPaused2()) {
				...
				msg = "Press Enter to Play" + (tetris.isNewGame2() ? "" : " Again");
				 ...
				 */
				TileType2 type = tetris.getPieceType2();
		 ...
		 */
		private void drawTile(TileType2 type, int x, int y, Graphics g) {
